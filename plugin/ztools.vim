...
func! ztools#switch_transparent_bg() abort " transparent background toggle
  if g:bg_flag_ == 1
    let g:bg_flag_ = 0
...
func! ztools#switch_buf_by_index(num) abort
  let l:buf_idx = a:num
...
func! ztools#switch_full_screen() abort
...
command! ZoomToggle call ztools#switch_full_screen()
command! -nargs=1 SwitchBuffer call ztools#switch_buf_by_index(<args>)

map <f4> :call ztools#switch_transparent_bg()<CR>
